...
/obj/machinery/media/jukebox
	...
	var/list/datum/track/tracks = list(
		...
		new/datum/track("Bluespace Ocean", 'sound/music/jukebox/bluespaceocean.ogg', "Cyberpunk"),
		new/datum/track("Never Gonna Give You Up", 'sound/music/jukebox/rickroll.mid', "Jazz"),
		new/datum/track("Fly Me to the Moon", 'sound/music/jukebox/flymetothemoon.mid', "Jazz"),
		new/datum/track("Cruel Angels Thesis", 'sound/music/jukebox/cruelangelsthesis.mid', "Jazz")
	)
