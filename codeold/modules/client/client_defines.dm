/client
	...
	preload_rsc = "https://persistentss13.com/persistentss13_01.zip" // This is 0 so we can set it to an URL once the player logs in and have them download the resources from a different server.
